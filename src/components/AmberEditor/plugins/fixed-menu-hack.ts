...
const spaceContent = function (menuEl: HTMLElement, contentEl: HTMLElement) {
...
const onScroll = function (menuEl: HTMLElement, contentEl: HTMLElement) {
...
export default {
  view: function (editorView: any) {
    ...
    return {
      update: function (editorView: any) {
        boundSpaceContent()
      },
      destroy: function () {
